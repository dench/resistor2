...
class LangRequest extends Request
{
    ...
    public function getLangUrl()
    {
        if ($this->_lang_url === null) {
            ...
            if ($lang_url !== null && $lang_url === Language::getCurrent()->id &&
                strpos($this->_lang_url, Language::getCurrent()->id) === 1)
            {
                $this->_lang_url = substr($this->_lang_url, strlen(Language::getCurrent()->id)+1);
            }
        }
